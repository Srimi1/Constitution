# THE CONSTITUTION — Master (v0.4)
### The one rule book every AI tool I run or ship obeys. The single source of truth — LIVE.
*v0.4 completes the moral core: ✦ The Soul (purpose, harm lines, costly honesty, how to treat people).*
...
*v0.4 — LIVE (2026-06-13). Moral core complete (✦ The Soul). The single source of truth, wired into `~/.claude/` and enforced by hooks + 5 Guardians + 5 Police agents. Prior versions frozen in `04 - Amendments & Versions`. Amend via the snapshot workflow.*
