...
*v0.3 — APPROVED & LIVE (2026-06-13). The single source of truth, wired into `~/.claude/` and enforced by hooks + 5 Guardians + 5 Police agents. Prior versions are frozen in `04 - Amendments & Versions`. Amend via the snapshot workflow.*
